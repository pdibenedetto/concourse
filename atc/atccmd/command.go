...
type RunCommand struct {
	...
	Server struct {
		...
		AdditionalHTTPHeaders     map[string]string `long:"http-header" description:"HTTP response headers to set on all responses. Can be specified multiple times." value-name:"NAME:VALUE"`
